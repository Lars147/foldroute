...
Browserbasierte Routenplanung für Faltrad und ÖPNV. Vite/TypeScript, Leaflet und direkte Transitous-Anfragen; kein eigener Server, keine Konten, keine Analyse-Tools. Gültige Routing-Einstellungen werden in `localStorage` gespeichert. Die standardmäßig eingeschaltete Fahrten-Speicherung hält bis zu 20 unterschiedliche geplante Strecken einschließlich Start, Ziel, Zwischenzielen, Etappen, Geometrie, Einstellungen und Abfragezeit in IndexedDB. Ausschalten löscht diesen Verlauf; Favoriten, bis zu 20 zuletzt ausgewählte Orte und Einstellungen bleiben lokal erhalten. „Alle lokalen Daten löschen“ entfernt auch diese Daten. Keine eingegebenen Suchtexte und keine GPS-Spuren werden gespeichert. Ortssuchen und Planungsangaben einschließlich gewählter Zwischenziele gehen an Transitous; Kartenabrufe an OpenStreetMap.
...
- Progressive Ergebnisse; bis zu drei reguläre Alternativen plus optionaler Fahrradvergleich. Eine ausdrücklich ausgewählte Reise oder das bewusste Öffnen ihrer Details hält die Auswahl beim Nachladen; sonst folgt die automatische Auswahl besseren Ergebnissen.
...
- Eingabezeiten verwenden die lokale Browser-Zeitzone. Die Zielauswahl startet die Berechnung automatisch, standardmäßig ab aktuellem Standort und jetzt. Manuelle Start-/Zeitvorgaben bleiben erhalten. Routenanpassungen bleiben Entwürfe bis zur Übernahme. Gültige Einstellungsänderungen werden sofort gespeichert und lösen beim Verlassen eine neue Berechnung aus. Bis zu einem neuen Ergebnis bleibt die bisherige Verbindung mit einem Hinweis auf die vorherigen Einstellungen sichtbar. Aktualisierung, Abbruch und neue Planung verhindern verspätete Antworten; fehlgeschlagene Aktualisierungen erhalten vorherige Ergebnisse.
...
Das Teilen-Symbol neben dem Schließen-X öffnet den Systemdialog zum Teilen der Planung. Ohne Unterstützung oder bei einem Fehler wird der Link kopiert; ist die Zwischenablage gesperrt, erscheint ein markierbares Linkfeld. Ein Abbruch des Teilen-Dialogs löst keine Kopieraktion aus.
...
- Zielsuche als Einstieg, danach Karte mit dunklem Routenpanel. Die normale Übersicht passt ihre Höhe an Zeiten, Dauer, Verbindungsauswahl und Hinweise an. Etappen erscheinen erst unter „Mehr Details“; „Weniger Details“ kehrt zur Übersicht zurück. Kartenberührung oder Ziehen nach unten minimiert das Panel, „Übersicht öffnen“ stellt die normale Ansicht wieder her. In der Detailansicht oder bei zu wenig Platz scrollt der gemeinsame Inhaltsbereich. Reicht der Platz auch für Kopfzeile und Aktionen nicht aus, scrollt das gesamte Panel; einzelne Hinweise haben keine eigenen Scrollbereiche. Ab 900 px steht das 420 px breite Panel links über der Karte.
- „Alle Routen anzeigen“ unter der Standort-Schaltfläche passt alle angebotenen Alternativen einschließlich Fahrradvergleich und Zwischenstopps in die freie Kartenfläche ein; bei nur einer Verbindung heißt der Button „Gesamte Route anzeigen“. Panelmodus und Scrollposition bleiben erhalten. Die Aktion beendet eine laufende Standortabfrage und funktioniert auch offline; sie berechnet keine neue Route. Wenn das mobile Panel die Karte vollständig bedeckt, macht „Karte anzeigen“ die Karte und ihre Aktionen zugänglich; „Reise anzeigen“ kehrt zum Panel zurück. Verdeckte Kartenaktionen sind nicht per Tastatur erreichbar.
...
- Alternativen folgen wie iOS frühester Ankunft beziehungsweise spätester Abfahrt bei Ankunftsvorgabe. Wischen über die Zusammenfassung, Links/Rechts-Tasten oder Auswahlschaltflächen wechseln die Verbindung. Nachgeladene Ergebnisse werden automatisch ausgewählt, solange keine manuelle Auswahl erfolgte und keine Details bewusst geöffnet wurden. Ein Wechsel bleibt über die angezeigten Routenalternativen möglich.
...
- „Einstellungen“ speichert jede gültige Änderung. Die bisherige Verbindung bleibt als Ergebnis der vorherigen Einstellungen gekennzeichnet. Beim Verlassen über „Fertig“ oder einen anderen Tab wird einmal mit den letzten Werten neu berechnet; der gewählte Tab bleibt geöffnet. Browser-Zurück stellt den vorherigen Planungskontext wieder her. Browser-Vorwärts erhält einen noch ausstehenden Einstellungsversuch, ohne einen bereits abgeschlossenen Versuch automatisch zu wiederholen. Bei Fehlern bleibt die Verbindung verfügbar; „Erneut versuchen“ und „Route anpassen“ führen weiter. Alte Ergebnisse werden nicht unter den neuen Einstellungen gespeichert. Die Offline-Reise bleibt unabhängig davon als gespeicherter Stand erhalten.
...
Die lokale Einstellung „Bildschirm während der Route eingeschaltet lassen“ ist standardmäßig aktiv. Die PWA fordert einen Screen Wake Lock nur für die sichtbare Routenvorschau an und gibt ihn bei Routenbearbeitung, Ansichtswechsel oder Hintergrundwechsel frei. Bei Rückkehr wird er erneut angefordert. Fehlende Unterstützung oder eine Ablehnung durch das System beeinträchtigen die Planung nicht. Die Einstellung wird nicht in Planungslinks oder Routing-Einstellungen übernommen.
